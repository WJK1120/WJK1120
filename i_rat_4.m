 %% Izhikevich   4:1 AB  电耦合--规则连接   3层每层5个   放电率随耦合度变化
clear;clc;
tic
m = 10;        % 10层
n = 5;         % 每层5个
...
D=0:0.5:100;
figure(1)
plot(D,A_rat1,'-diamonk','Markersize',4,'LineWidth',1.5);hold on   %  抑制性神经元
plot(D,A_rat2,'-.or','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat3,'-->b','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat4,'-.og','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat5,'-.oc','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat6,'-.om','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat7,'-.oy','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat8,'-.ok','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat9,'-.om','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat10,'-.ob','Markersize',4,'LineWidth',1.5);
legend({'lay1','lay2','lay3','lay4','lay5','lay6','lay7','lay8','lay9','lay10'});  % 加 图 例                    
xlabel('感应电流(uA/cm^2)','FontSize',30);                           % X 轴标注设置字体大小
ylabel('频率(kHz)','FontSize',30);                       % Y 轴标注设置字体大小
...
plot(D,A_rat11,'-diamonk','Markersize',4,'LineWidth',1.5);hold on   %  抑制性神经元
plot(D,A_rat12,'-.or','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat13,'-->b','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat14,'-.og','Markersize',4,'LineWidth',1.5);hold on 
plot(D,A_rat15,'-.oc','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat16,'-.om','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat17,'-.oy','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat18,'-.ok','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat19,'-.om','Markersize',4,'LineWidth',1.5);hold on
plot(D,A_rat20,'-.ob','Markersize',4,'LineWidth',1.5);
legend({'lay1','lay2','lay3','lay4','lay5','lay6','lay7','lay8','lay9','lay10'});  % 加 图 例   
% legend({'lay1','lay2','lay3'});
xlabel('感应电流(uA/cm^2)','FontSize',30);ylabel('频率(kHz)','FontSize',30);
